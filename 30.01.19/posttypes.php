...
$labels = array(
    ...
    $args = array(
        ...
        'rest_controller_class' => 'WP_REST_Posts_Controller',
        'supports'           => array( 'title', 'editor', 'excerpt', 'author', 'thumbnail', 'comments', 'revisions', 'custom-fields' ),
        'taxonomies'         => array('WorkTypes','category','post_tag'),
        // ,'custom-fields','excerpt'
    );
    register_post_type('AllWorks',$args);
...
function my_custom_taxonomies(){
    ...
    register_taxonomy( 'BlogTypes', array( 'AllBlogs' ), $args );
        ...
        $labels = array(
        'name' => 'WorkTypes',
        'singular_name' => 'WorkType',
        'search_items' => 'Search WorkType',
        'all_items' => 'All WorkTypes',
        'parent_item' => 'Parent Type All WorkTypes',
        'parent_item_colon' => 'Parent Type All WorkTypes:',
        'edit_item' => 'Edit Type of WorkType',
        'update_item' => 'Update Type of WorkType',
        'add_new_item' => 'Add New Type of WorkType',
        'new_item_name' => 'New Type of WorkType',
        'menu_name' => 'Type of WorkType', 
        );
    ...
    $args = array(
        ...
        'show_admin_column' => true,
        'query_var'         => true,
        'rewrite'           => array( 'slug' => 'WorkTypes' ),
    );
    register_taxonomy( 'WorkTypes', array( 'AllWorks' ), $args );
